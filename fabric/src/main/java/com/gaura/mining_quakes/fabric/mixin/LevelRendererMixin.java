...
public class LevelRendererMixin {
    ...
    private void onRenderBlockDestroyAnimation(BlockRenderDispatcher blockRenderDispatcher, BlockState blockState, BlockPos blockPos, BlockAndTintGetter blockAndTintGetter, PoseStack poseStack, VertexConsumer vertexConsumer, Operation<Void> original) {

        if (!BlockQuakeParticleManager.isBlockInvisible(blockPos)) {

            original.call(blockRenderDispatcher, blockState, blockPos, blockAndTintGetter, poseStack, vertexConsumer);
        }
    }
}
